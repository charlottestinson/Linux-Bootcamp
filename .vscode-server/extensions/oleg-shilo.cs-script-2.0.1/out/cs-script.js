...
// -----------------------------------
let core_engine = path.join(utils_1.user_dir(), "dotnet", "cscs.dll");
...
function generate_proj_file(proj_dir, scriptFile) {
    try {
        ...
        let src_vscode_dir = path.join(utils_1.user_dir(), 'dotnet', '.vscode');
...
// -----------------------------------
function css_config() {
    utils.ensure_default_core_config(core_engine, config_file => {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        utils_1.with_lock(() => {
            ...
            let launchConfigCore = {
                ...
                request: "launch",
                program: "dotnet",
                args: [core_engine, "-d", extra_args().replace("-co:/debug:pdbonly", ""), utils_1.vsc_config.get("cs-script.extra_args"), "", "-l", config, "-ac:2", editor.document.fileName],
